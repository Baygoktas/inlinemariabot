...
from info import ADMINS, AUTH_CHANNEL, LOG_CHANNEL, SUPPORT_CHAT
    ...
    if temp.ME in r_j_check:
        ...
        if message.chat.id in temp.BANNED_CHATS:
            ...
            k = await message.reply(
                text='bu sohbeti sahibim yasaklamış. üzgünüm. elveda.',
